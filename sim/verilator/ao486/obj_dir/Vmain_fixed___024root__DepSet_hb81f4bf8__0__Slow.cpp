...
VL_ATTR_COLD void Vmain_fixed___024root___eval_static__TOP(Vmain_fixed___024root* vlSelf);
VL_ATTR_COLD void Vmain_fixed___024root____Vm_traceActivitySetAll(Vmain_fixed___024root* vlSelf);

VL_ATTR_COLD void Vmain_fixed___024root___eval_static(Vmain_fixed___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vmain_fixed__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmain_fixed___024root___eval_static\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    Vmain_fixed___024root___eval_static__TOP(vlSelf);
    Vmain_fixed___024root____Vm_traceActivitySetAll(vlSelf);
}

VL_ATTR_COLD void Vmain_fixed___024root___eval_static__TOP(Vmain_fixed___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vmain_fixed__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmain_fixed___024root___eval_static__TOP\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vmain_fixed___024root___eval_initial(Vmain_fixed___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vmain_fixed__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmain_fixed___024root___eval_initial\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vmain_fixed___024root___eval_final(Vmain_fixed___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vmain_fixed__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmain_fixed___024root___eval_final\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
}

#ifdef VL_DEBUG
VL_ATTR_COLD void Vmain_fixed___024root___dump_triggers__stl(Vmain_fixed___024root* vlSelf);
#endif  // VL_DEBUG
VL_ATTR_COLD bool Vmain_fixed___024root___eval_phase__stl(Vmain_fixed___024root* vlSelf);

VL_ATTR_COLD void Vmain_fixed___024root___eval_settle(Vmain_fixed___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vmain_fixed__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmain_fixed___024root___eval_settle\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
#ifdef VL_DEBUG
            Vmain_fixed___024root___dump_triggers__stl(vlSelf);
#endif
            VL_FATAL_MT("main_fixed.v", 1, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (Vmain_fixed___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD void Vmain_fixed___024root___dump_triggers__stl(Vmain_fixed___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vmain_fixed__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmain_fixed___024root___dump_triggers__stl\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vmain_fixed___024root___stl_sequent__TOP__0(Vmain_fixed___024root* vlSelf);
VL_ATTR_COLD void Vmain_fixed___024root___stl_sequent__TOP__1(Vmain_fixed___024root* vlSelf);
VL_ATTR_COLD void Vmain_fixed___024root___stl_sequent__TOP__2(Vmain_fixed___024root* vlSelf);

VL_ATTR_COLD void Vmain_fixed___024root___eval_stl(Vmain_fixed___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vmain_fixed__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmain_fixed___024root___eval_stl\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        Vmain_fixed___024root___stl_sequent__TOP__0(vlSelf);
        Vmain_fixed___024root____Vm_traceActivitySetAll(vlSelf);
        Vmain_fixed___024root___stl_sequent__TOP__1(vlSelf);
        Vmain_fixed___024root___stl_sequent__TOP__2(vlSelf);
    }
}
...
VL_ATTR_COLD void Vmain_fixed___024root___stl_sequent__TOP__0(Vmain_fixed___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vmain_fixed__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmain_fixed___024root___stl_sequent__TOP__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
